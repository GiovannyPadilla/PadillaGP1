...
namespace PadillaGP1.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public ReservasController(PadillaGP1Context context)
        {
            _context = context;
        }
        ...
        {
            var padillaGP1Context = _context.Reserva.Include(r => r.Cliente);
            return View(await padillaGP1Context.ToListAsync());
        }
